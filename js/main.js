...
var onChangeRoomSelect = function (evt) {
...
infoFormRoomNumber.addEventListener('change', onChangeRoomSelect);
infoFormCapacity.addEventListener('change', onChangeRoomSelect);
